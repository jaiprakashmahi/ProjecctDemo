    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Organizations</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/edit-organization-save') }}">

                        {{ csrf_field() }}

                        <input type="hidden" name="id" value="{{$organizationDataEdit->id}}">
                        ...
                        <div class="form-group{{ $errors->has('organizationName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="organizationName" type="text" class="form-control"
                                       required="required" name="organizationName" value="{{$organizationDataEdit->organizationName}}">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="4" cols="30" class="form-control" required="required" name="description" id="description">
                                    {{ $organizationDataEdit->organizationName }}
                                </textarea>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> Edit Organization
                                </button>
                            </div>
                        </div>
                    </form>
